    ...
    <main class="explore-main-content">
        <section class="explore-hero-section">
            <div class="explore-hero-text-container">
                ...
                <p class="explore-hero-text">Budaya tak lagi hanya diceritakan, kini bisa kamu eksplorasi secara digital.
                    Satu klik untuk ribuan tradisi, kuliner, dan seni Nusantara.</p>
            </div>
            <div class="explore-hero-image-container">
                <img src="{{ asset('images/explore_asset/heroexplore.png') }}" alt="Ilustrasi Budaya Nusantara"
                    class="explore-hero-image">
            </div>
        </section>
        ...
        <section class="explore-culinary-section">
            ...
            <div class="explore-culinary-list">
                <a href="/detail" class="explore-culinary-card">
                    <img src="{{ asset('images/explore_asset/satemadura.jpg') }}" alt="Sate Madura"
                        class="explore-culinary-image">
                ...
                <a href="/detail" class="explore-culinary-card">
                    <img src="{{ asset('images/explore_asset/rendang.jpg') }}" alt="Rendang"
                        class="explore-culinary-image">
                    <div class="explore-culinary-content">
                ...
                <a href="/detail" class="explore-culinary-card">
                    <img src="{{ asset('images/explore_asset/gadogado.jpg') }}" alt="Gado-Gado"
                        class="explore-culinary-image">
                    <div class="explore-culinary-content">
        ...
        <section class="explore-articles-section">
            ...
            <div class="explore-articles-list">
                <a href="/detail" class="explore-article-card">
                    <img src="{{ asset('images/explore_asset/gamelan.jpg') }}" alt="Gamelan: Harmoni yang Mendunia"
                    ...
                    <div class="explore-article-content">
                        ...
                        <p class="explore-article-excerpt">Gamelan adalah alat musik tradisional yang berasal dari Jawa dan
                            Bali, Indonesia...</p>
                    </div>
                </a>
                <a href="/detail" class="explore-article-card">
                    <img src="{{ asset('images/explore_asset/tarisaman.jpg') }}" alt="Tari Saman"
                        class="explore-article-image">
                    <div class="explore-article-content">
                ...
                <a href="/detail" class="explore-article-card">
                    <img src="{{ asset('images/explore_asset/manusiajawakuno.jpeg') }}" alt="Wajah Manusia Jawa Kuno"
                        class="explore-article-image">
                    <div class="explore-article-content">
                        <h3 class="explore-article-title">Wajah Manusia Jawa Kuno di Indonesia</h3>
                        <p class="explore-article-meta">oleh Redaksi | Pustaka & Artikel</p>
                        <p class="explore-article-excerpt">Penemuan fosil manusia purba di Jawa memberikan wawasan unik
                            tentang sejarah...</p>
                    </div>
                </a>
                <a href="/detail" class="explore-article-card">
                    <img src="{{ asset('images/explore_asset/rajaindonesia.jpg') }}" alt="Menjelajahi Sejarah Raja-Raja"
                        class="explore-article-image">
                    <div class="explore-article-content">
                ...
                <a href="/detail" class="explore-article-card">
                    <img src="{{ asset('images/explore_asset/gandrungsewu.png') }}" alt="Festival Gandrung Sewu"
                        class="explore-article-image">
                    <div class="explore-article-content">
                        <h3 class="explore-article-title">Festival Gandrung Sewu</h3>
                        <p class="explore-article-meta">oleh Redaksi | Pustaka & Artikel</p>
                        <p class="explore-article-excerpt">Festival Gandrung Sewu adalah perayaan budaya yang megah di
                            Banyuwangi...</p>
                    </div>
                </a>
                <a href="/detail" class="explore-article-card">
                    <img src="{{ asset('images/explore_asset/nyadran.webp') }}" alt="Festival Gandrung Sewu"
                        class="explore-article-image">
                    <div class="explore-article-content">
                        <h3 class="explore-article-title">Tradisi Nyadran</h3>
                        <p class="explore-article-meta">oleh Redaksi | Pustaka & Artikel</p>
                        <p class="explore-article-excerpt">tradisi masyarakat Jawa sebagai bentuk rasa syukur dengan
                            berziarah...</p>
                    </div>
                </a>
            </div>
        ...
        <section class="explore-pustaka-section">
            ...
            <div class="explore-pustaka-list">
                <a href="/detail" class="explore-pustaka-card">
                    <img src="{{ asset('images/explore_asset/timunmas.jpg') }}" alt="Timun Mas"
                        class="explore-pustaka-image">
                ...
                <a href="/detail" class="explore-pustaka-card">
                    <img src="{{ asset('images/explore_asset/aksarajawa.png') }}" alt="Aksara Jawa"
                        class="explore-pustaka-image">
                    <div class="explore-pustaka-content">
                ...
                <a href="/detail" class="explore-pustaka-card">
                    <img src="{{ asset('images/explore_asset/danautoba.jpg') }}" alt="Danau Toba"
                        class="explore-pustaka-image">
                    <div class="explore-pustaka-content">
                ...
                <a href="/detail" class="explore-pustaka-card">
                    <img src="{{ asset('images/explore_asset/suratbatak.png') }}" alt="Danau Toba"
                        class="explore-pustaka-image">
                    <div class="explore-pustaka-content">
        ...
        <section class="explore-event-section">
            ...
            <div class="explore-event-list">
                <a href="#" class="explore-event-card">
                    <img src="{{ asset('images/explore_asset/festivalnusantara.png') }}" alt="Festival Nusantara 2024"
                        class="explore-event-image">
                ...
                <a href="/explore" class="explore-event-card">
                    <img src="{{ asset('images/explore_asset/taritradisional.png') }}" alt="Tari Tradisional"
                        class="explore-event-image">
                    <div class="explore-event-content">
                ...
                card.addEventListener('mousemove', (e) => {
                    ...
                    if (bgElement) {
                        ...
                        bgElement.style.transform =
                            `scale(1.15) translate(${translateX}%, ${translateY}%)`;
                    }
                });
